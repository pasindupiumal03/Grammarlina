...
export default function LoginPage() {
  ...
  const handleGoogleLogin = isGoogleOAuthConfigured ? useGoogleLogin({
                  ...
                  <form onSubmit={handleLogin} className="space-y-5">
                    ...
                    >
                      <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full text-white h-11 rounded-md font-medium shadow-lg border-0 transition-all duration-200 hover:opacity-90 disabled:opacity-50 primary-gradient"
                      >
                        {isLoading ? (
                          <motion.div
                            animate={{ rotate: 360 }}
